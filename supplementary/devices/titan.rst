...
A port to **Halium 7.1 is being worked on** by `Walid Hammami <https://github.com/walidham>`_. The according Halium/projectmanagement issue can be found `here <https://github.com/Halium/projectmanagement/issues/20>`_. 
